...
Small and somewhat hackish modifications were made by Lourens Veen for
supporting MPI and setting the number of MPI ranks and OpenMP threads.
...
while [ -n "$1" ]; do
	...
	-control)  CONTROL=$2                           ; shift 2; continue ;;
...
function MDRUNNER ()
{
	...
	local z=1; while [[ -f $DIR/$baseOUT.part$(printf "%04d" $z).log ]]; do z=$((z+1)); done
